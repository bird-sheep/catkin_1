...
get_filename_component(_filename "/home/px/code/catkin_1/src/ros_service_examples/srv/MP3InventoryService.srv" NAME_WE)
add_custom_target(_ros_service_examples_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_service_examples" "/home/px/code/catkin_1/src/ros_service_examples/srv/MP3InventoryService.srv" ""
)
...
_generate_srv_cpp(ros_service_examples
  "/home/px/code/catkin_1/src/ros_service_examples/srv/MP3InventoryService.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_service_examples)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_service_examples\")")
  # install generated code
  install(
